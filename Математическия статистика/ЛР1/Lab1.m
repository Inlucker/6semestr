...
fprintf("Максимальный элемент выборки = ") %Максимальный элемент выборки
disp(Mmax)
fprintf("Минимальный элемент выборки = ") %Минимальный элемент выборки
disp(Mmin)
fprintf("Размах выборки = ") %Размах выборки
disp(R)
fprintf("Выборочное среднее = ") %Выборочное среднее
disp(mu)
fprintf("Исправленная выборочная дисперсия = ") %Исправленная выборочная дисперсия
disp(Ssqr)
fprintf("Кол-во интервалов = ") %Кол-во интервалов
disp(m)
fprintf("Статистический интервальный ряд = \n") %Статистический интервальный ряд
disp(Intervals)